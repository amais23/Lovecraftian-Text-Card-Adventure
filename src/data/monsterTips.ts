...
export const MONSTER_TACTICAL_TIPS: Record<string, MonsterTacticalTips> = {
  ...
  enemy_arkham_cultist: {
    ...
    strategy: '使用【鉛頭手杖】及時消除其力量增益，或在觸發血祭前一發雙管獵槍直接擊殺，避免其觸發血祭。',
    traitTrigger: '生命值低於 40% 時發動【盲目血祭】，消耗自身 4 點生命值向調查員施加 2 層流血與 1 層易傷。',
  },
  enemy_ghoul_lurker: {
    threatSummary: '一旦調查員身上帶有流血狀態，食屍鬼會透過攻擊持續吸血，戰鬥易陷入拖延。',
    recommendedCards: ['醫療鎮定劑 (淨化流血)', '戰地急救繃帶 (解流血)', '軍刀突刺 (穿透傷害)'],
  ...
  enemy_cultist_zealot: {
    threatSummary: '生命值低於 50% 時進入狂暴態，平砍也會撕裂理智牌庫，拖延戰鬥極度危險。',
    recommendedCards: ['雙管獵槍 (高額斬殺)', '弱點狙擊 (一槍斃命)', '軍刀突刺'],
    strategy: '在生命值降至半數前積蓄爆發卡牌，一擊越過狂暴臨界點將其斬殺。',
  ...
  enemy_ghoul_high_priest: {
    threatSummary: '生命值與護甲皆極為堅實，同時具備 12 點重擊與 3 點心智侵蝕，是第一深度最強門檻。',
    recommendedCards: ['泵動式散彈槍 (擊碎骨甲)', '軍刀突刺 (穿透傷害直扣生命值)', '戰術翻滾'],
  ...
  enemy_deep_one_warrior: {
    ...
    recommendedCards: ['軍刀突刺 (穿透傷害無視免疫)', '雙管獵槍 (16傷重轟)', '靈能衝擊 (法術無視物理皮甲)'],
    strategy: '切忌使用單段 4 傷以下小技能，果斷使用【軍刀突刺】或高傷武器直接破防。',
    traitTrigger: '逼迫調查員使用高傷重武器、穿透傷害攻擊或紫色秘術法術破防。',
  },
  enemy_drowned_soul: {
  ...
  enemy_innsmouth_hybrid: {
    ...
    recommendedCards: ['軍刀突刺 (穿透傷害無視護甲)', '雙管獵槍 (高額重轟)', '重拳壓制'],
  ...
  enemy_abyssal_barnacle_mass: {
    ...
    recommendedCards: ['泵動式散彈槍 (擊碎護甲)', '靈能衝擊 (法術無視甲殼)', '軍刀突刺'],
  ...
  enemy_deep_one_elder: {
    ...
    recommendedCards: ['弱點狙擊 (單次致命爆發)', '泵動式散彈槍 (擊碎護甲)', '極限精神錨定'],
  ...
  enemy_dagon_champion: {
    ...
    strategy: '快速削弱其生命值，在其疊加致命力量前完成擊殺。',
  ...
  enemy_dagon_priest: {
    threatSummary: '第二深度首要機制威脅，奇數回合若未破除 16 點潮汐護甲，偶數回合的海嘯打擊將造成毀滅性傷害。',
    recommendedCards: ['泵動式散彈槍 (一槍擊碎所有護甲)', '深淵靈能撕裂 (破甲50%)', '護甲猛擊'],
    strategy: '保留【泵動式散彈槍】等高爆發破甲牌，於奇數回合粉碎其潮汐護甲即可化解海嘯攻勢。',
    traitTrigger: '迫使調查員在奇數回合傾瀉所有輸出破除護甲，否則偶數回合將面臨滅頂之災。',
  },
  initial_dagon_priest: {
    threatSummary: '大袞密教祭司前哨引導者，能透過潮汐儀式聚集高達 16 點護甲並引發海嘯。',
    recommendedCards: ['泵動式散彈槍 (一槍擊碎所有護甲)', '深淵靈能撕裂 (破甲50%)', '護甲猛擊'],
    strategy: '在奇數回合其召喚潮汐護甲時全力輸出將其擊破，避免偶數回合承受致命海嘯衝擊。',
    traitTrigger: '潮汐儀式使自身獲得厚重護甲，並於次次回合轉化為全場巨額打擊。',
  },
  ...
  enemy_void_wanderer: {
    ...
    recommendedCards: ['不可侵犯之壁 (留存護甲)', '深淵靈能撕裂 (穿透傷害（無視護甲）)', '弱點狙擊'],
    strategy: '在其蓄力四維打擊時做好全額護甲防護，把握其護甲間隙全力爆發。',
  ...
  enemy_formless_spawn: {
    threatSummary: '易傷與流血無效，單純靠平砍會被反彈大量生命值傷害。',
    recommendedCards: ['靈能衝擊 (法術直傷)', '深淵靈能撕裂 (穿透傷害)', '護甲猛擊 (巨量護甲砸擊)'],
    strategy: '偵探可利用【不可侵犯之壁】疊厚甲後用【護甲猛擊】一發重創，學者則直接使用高階秘術法術轟擊。',
    traitTrigger: '純物理菜刀隊的天然克星，需使用魔法直傷或穿透傷害破除。',
  },
  ...
  enemy_ancient_hound: {
    ...
    recommendedCards: ['多段打擊卡牌', '高額護甲防禦', '穿透傷害'],
  ...
  enemy_colossal_shoggoth: {
    ...
    recommendedCards: ['不可侵犯之壁 (跨回合留存護甲)', '軍用特種炸藥包 (爆轟破甲)', '虛空黑洞坍縮'],
  ...
  initial_colossal_shoggoth: {
    threatSummary: '原初巨型修格斯原體，擁有 110 點龐大生命值與毀滅級壓頂蓄力。',
    recommendedCards: ['不可侵犯之壁 (跨回合留存護甲)', '軍用特種炸藥包 (高額破甲爆轟)', '虛空黑洞坍縮'],
    strategy: '把握其泰山壓頂蓄力期受傷加深的弱點，全力傾瀉爆發牌實施精準打擊。',
    traitTrigger: '蓄力期間承受傷害增加，次次回合引發致死級物理碾壓。',
  },

  // --- 第四深度 ---
  enemy_rlyeh_sarcophagus_guard: {
    threatSummary: '生命值龐大且具備堅實護甲，巨石衝撞與深淵重壓威脅極大，伴隨持續恐慌。',
    recommendedCards: ['軍刀突刺 (穿透傷害)', '深淵靈能撕裂', '泵動式散彈槍 (擊碎護甲)'],
    strategy: '使用穿透傷害（無視護甲）牌或高階法術直擊本體，避免與 14 點太古封印硬耗。',
    traitTrigger: '每回合被動恐慌，巨石防禦極為堅固。',
  },
  enemy_rlyeh_guard: {
    threatSummary: '拉萊耶巨石近衛，防禦森嚴且攻擊勢大力沉。',
    recommendedCards: ['泵動式散彈槍', '穿透傷害', '虛空射線'],
    strategy: '破除護甲後迅速以爆發傷害斬殺。',
  ...
  enemy_non_euclidean_construct: {
    ...
    recommendedCards: ['法術直傷', '穿透傷害', '不可侵犯之壁'],
  ...
  enemy_cosmic_prophet: {
    ...
    recommendedCards: ['就地掩蔽 (蓄積高額護甲)', '雙管獵槍 (爆發壓制)', '重拳壓制 (-30%傷)'],
    strategy: '在超新星震擊前夕務必打出【重拳壓制】削弱其傷害，並用淨化牌解掉易傷。',
    traitTrigger: '每 3 回合施加易傷與恐慌，蓄力超新星狂怒 22 點毀滅傷害。',
  },
  enemy_ancient_guardian: {
    threatSummary: '完全免疫破甲碎甲，任何攻擊都會讓其產生護甲反彈。',
    recommendedCards: ['軍刀突刺 (穿透傷害直擊本體)', '深淵靈能撕裂 (無視護甲)', '屠神裁決爆轟'],
    strategy: '不要與其堅厚護甲死磕，全體改用【穿透傷害（無視護甲）】卡牌直扣生命核心。',
  ...
  initial_star_spawn: {
    threatSummary: '星之眷族古老顯現形態，神性庇護下常規攻擊全然無效。',
    recommendedCards: ['完整的深淵古印 (破除神性)', '舊神庇護之陣 (減傷40%)', '屠神裁決爆轟', '源初星辰啟示'],
    strategy: '必須打出【完整的深淵古印】消除其不可名狀庇護，再以最高輸出卡牌貫穿生命核心。',
    traitTrigger: '持續將【星辰碎裂之囈語】注入調查員牌庫，造成心智崩潰與戰鬥干擾。',
  },
};
